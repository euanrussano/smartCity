...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AccountHolder',
            fields=[
                ('accountHolder_id', models.AutoField(primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=datetime.datetime(2020, 12, 16, 21, 21, 46, 368002, tzinfo=utc), verbose_name='date created')),
        ...
        migrations.CreateModel(
            name='City',
            fields=[
                ('accountholder_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='iot.accountholder')),
                ('name', models.CharField(max_length=200)),
                ('latitude', models.FloatField(default=0.0)),
                ('longitude', models.FloatField(default=0.0)),
                ('radius', models.FloatField(default=0.0)),
            ],
            bases=('iot.accountholder',),
        ),
        migrations.CreateModel(
            name='CO2Meter',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_holder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='iot.city')),
            ],
            bases=('iot.accountholder',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('holder', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='iot.accountholder')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Resident',
            fields=[
                ('accountholder_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='iot.accountholder')),
                ('person_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='iot.person')),
                ('name', models.CharField(max_length=200)),
            ...
            bases=('iot.person', 'iot.accountholder'),
        ),
        migrations.AddField(
            model_name='outputsensor',
            name='device',
